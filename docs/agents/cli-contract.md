...
lastReviewedNote: "Reviewed for Issue #160 phase 1: the v0.1.4 packaging update changes only the exact published version and installation examples, not the unified command or report contracts."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
