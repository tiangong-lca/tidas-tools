...
lastReviewedNote: "Issue #162 phase 2 binds the immutable v0.1.4 Release Request to the qualified version-set merge commit without changing crate ownership or release architecture."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./cli-contract.md
